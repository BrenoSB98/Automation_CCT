...
def process_contracts(source_sheet, destination_sheet, source_row):
    ...
    try:
        ...
        try:
            ...
            # Carregador (coluna 2 na origem, coluna 4 no destino - enviando apenas o valor da fórmula)
            ...
            # CNPJ Carregador (coluna 3 na origem, coluna 5 no destino)
            ...
            # Modalidade (coluna 4 na origem, coluna 6 no destino)
            ...
            # Regime de Contratação (coluna 5 na origem, coluna 7 no destino)
            ...
            # Periodicidade (coluna 6 na origem, coluna 8 no destino)
            ...
            # Término (coluna 8 na origem, coluna 10 no destino)
            ...
            # Local Assinatura (coluna 9 na origem, coluna 11 no destino)
            ...
            # Data Assinatura (coluna 10 na origem, coluna 12 no destino)
            ...
            # Doc SEI inteiro Teor (coluna 11 na origem, coluna 13 no destino)
            ...
            # Processo Admin (coluna 12 na origem, coluna 14 no destino)
            ...
            # Doc SEI Minuta (coluna 14 na origem, coluna 18 no destino)
            ...
            # Doc SEI versão Tarjada (coluna 15 na origem, coluna 19 no destino)
            ...
            # COD Transportadora (coluna 16 na origem, coluna 20 no destino)
