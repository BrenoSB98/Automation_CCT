...
def generate_sequential_year(destination_sheet):
    ...
    try:
        ...
        try:
            ...
            raise ValueError(f"Erro ao acessar o ano na linha {last_row}, coluna Ano de Registro: {e}")
        ...
        if last_year != current_year:
            ...
            try:
                ...
                raise ValueError(f"Erro ao acessar o sequencial na linha {last_row}, coluna Sequencial Anual: {e}")
